        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsKeyDecisionMaker = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CabinetNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ...
                    RegionalCompany = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    AffiliatedCompany = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentPlans_Contracts_ContractId",
                        column: x => x.ContractId,
                        principalTable: "Contracts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_CreditCode",
                table: "Customers",
                column: "CreditCode",
                unique: true,
                filter: "[CreditCode] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentPlans_ContractId",
                table: "PaymentPlans",
                column: "ContractId");
        }
